            ...
            <Row>
              ...
              <Col lg="6" className="p-3">
                ...
                <div className="d-flex align-items-center mt-4 mb-3 justify-content-center gap-1 flex-wrap">
                  <h6 className=" text text-center py-3 rounded-5 w-25">
                    healthy
                  </h6>
                  <h6 className=" text text-center py-3 rounded-5 w-25">
                    hygienic
                  </h6>
                  <h6 className=" text text-center px-5 py-3 rounded-5">
                    fastest delivery
                  </h6>
                </div>
                ...
                <div>
                  <Button
                    className="title border-0 text w-100 p-3"
                      ...
                      <NavLink
                        className={
                          activeTab === "customer reviews"
                            ? "text title border-0 px-5 my-2 rounded-5 "
                            : "text"
                        }
                      ...
                      <NavLink
                        className={
                          activeTab === "other products"
                            ? "text title border-0 px-5 rounded-5 "
                    ...
                    <TabPane tabId="customer reviews" className="p-3">
                      ...
                      {userInfo && (
                        ...
                        {product.reviews.map((review) => (
                          <div key={review._id} className="mb-3  p-4 rounded-3 w-25 d-flex align-items-center justify-content-lg-between flex-wrap">
                           ...
                           <h6 className="text">{review.name}</h6>
                            </div> 
                            ...
                            <h5 className="text">{`"${review.comment}"`}
                              </h5>
                          </div>
                        ))}
                         </div>
