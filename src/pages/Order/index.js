                      ...
                      order.orderItems.map((item) => (
                        <div key={item._id} className="w-100">
                          <div className=" d-flex align-items-center justify-content-around mt-2">
                            <img
                              style={{ width: "50px" }}
                              src={`https://orm-mat-be.onrender.com${item.image}`}
                              alt={item.name}
                            />
                            <p>{item.name}</p>
                ...
                <Col lg="4">
                  <div>
                    <Card>
                      ...
                      {paid ? (
                        <div className="text order-page p-2">
                          Payment success!
                        </div>
                      ) : (
                        <StripeCheckout
