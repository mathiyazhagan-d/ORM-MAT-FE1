    ...
    <>
      <Container className="mx-3">
        <Row className="gap-4">
          <Col
            lg="2"
            className="order-page text text-center py-5 mb-3 rounded-2"
          >
            <h5>
              No.of Users :{" "}
      ...
      <Container>
        <Row>
          ...
          <Col lg="4" className="order-page rounded-2 px-5 py-5 my-2">
            <h5 className="text-center fw-bold bg-light text p-2 rounded-2">
              New offers
            </h5>
            <h6 className="mt-3 text-start text   p-3 rounded-2">
              <FaTag />
              <span>
            ...
            <h6 className="mt-3 text bg-light p-3 rounded-2">
              <FaTag />
              <span>
